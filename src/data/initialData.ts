...
export const INITIAL_MODULES: SurveyModuleItem[] = [
  { id: 1, title: '1. Farmer / Stakeholder Survey', status: 'Not Started', icon: 'radio_button_unchecked' },
  { id: 2, title: '2. Field Survey & Geometry', status: 'Not Started', icon: 'radio_button_unchecked' },
  { id: 3, title: '3. Soil Survey (Physical & Chemical)', status: 'Not Started', icon: 'radio_button_unchecked' },
  { id: 4, title: '4. Water & Hydraulic Survey', status: 'Not Started', icon: 'radio_button_unchecked' },
